...
class My_Dataset(Dataset):
    ...
    def __init__(self,
        ...
        self.lidar_in_dir = os.path.join(self.input_path, "sparse_depth")
        # self.lidar_in_dir = os.path.join(self.input_path, "lidar_depth")
        self.rgb_in_dir = os.path.join(self.input_path, "images")
        # self.gt_in_dir = os.path.join(self.input_path, "Gt")
        
        self.lidar_in_path_list = [os.path.join(self.lidar_in_dir, filename) for filename in sorted(os.listdir(self.lidar_in_dir)) if filename.endswith(".npy")]
        # self.rgb_in_path_list = [os.path.join(self.rgb_in_dir, filename) for filename in sorted(os.listdir(self.rgb_in_dir))]
        self.rgb_in_path_list = [filename.replace("sparse_depth", "images").replace(".npy",".jpg") for filename in self.lidar_in_path_list]
